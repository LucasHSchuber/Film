        ...
        <div class="wrapper">
            ...
            <section>
                ...
                <div class='box-posts'> 
                    ...
                    <p class='post-media'>" . $post['media'] . " &nbsp; &#x2022; &nbsp; " . $post['genre'] . " &nbsp; &#x2022; &nbsp; " . $post['grade'] . "/10" . "<img src='images/symbols/star.png' alt='betyg, bild " . $post['id'] . "' width='18px' height='18px' style='margin-bottom:0.3em;'>" . "</p>
