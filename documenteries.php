    ...
    <main>
        ...
        <div class="hero-wrapper">
            <picture class="hero-image">
                <source srcset="images/doc2.jpg" media="(min-width: 1521px)">
                <source srcset="images/doc2.jpg" media="(min-width: 801px)">
                <img src="images/doc2.jpg" alt="bild på en person på ett fjäll" />
            </picture>
        </div>
