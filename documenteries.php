    ...
    <main>
        ...
        <div class="hero-wrapper">
            <picture class="hero-image">
                <source srcset="images/doku_mellan.jpg" media="(min-width: 1521px)">
                <source srcset="images/doku_mellan.jpg" media="(min-width: 801px)">
                <img src="images/doku_small.jpg" alt="bild på en person på ett fjäll" />
            </picture>
        </div>
        ...
        <div class="wrapper">
            ...
            <section class="box-films">
                ...
                <h1 class="grid-box-films">Dokumentärer.</h1>
